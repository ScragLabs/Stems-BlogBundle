...
use Stems\BlogBundle\Form\SectionTextType;
...
class SectionBlogHeader implements SectionInstanceInterface
{
    ...
    public function render($services, $link)
    {
        ...
        return $services->getTwig()->render('StemsBlogBundle:Section:blogHeader.html.twig', array(
            'section'   => $this,
            'link'      => $link,
        ));
    }
    ...
    public function editor($services, $link)
    {
        ...
        return $services->getTwig()->render('StemsBlogBundle:Section:blogHeaderForm.html.twig', array(
